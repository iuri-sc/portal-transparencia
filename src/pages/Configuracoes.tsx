...
function Section({ title, children }: SectionProps) {
  return (
    <div className="card mb-4 overflow-hidden">
      ...
      <div className="divide-y divide-gray-100 px-6 py-4 dark:divide-gray-100">{children}</div>
    </div>
  )
}
      ...
      <Section title="Dados e privacidade">
        ...
        <div className="py-3.5">
          ...
          <p className="text-sm leading-relaxed text-gray-400">
            Todos os dados são de domínio público, divulgados em comformidade com a Lei de Acesso à
            Informação (Lei n 12.527/2011). Atualizados mensalmente
          </p>
        </div>
      </Section>
