    ...
    return (
        <nav className="sticky top-0 z-50 flex h-16 items-center border-b border-white/10 bg-green-700 px-4 sm:px-6 dark:bg-gray-950">
            <div className="mx-auto flex w-full max-w-7xl items-center justify-between">
                ...
                >
                    <div className="bg-amber-400 font-display flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-lg text-green-700">
                        T
                    </div>
                    <div className="leading-tight">
                        <p className="font-display text-amber-400 text-sm leading-none">
